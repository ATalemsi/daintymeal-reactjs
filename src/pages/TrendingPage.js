            ...
            <div className="osahan-popular">
                <div className="p-3 osahan-inner-header bg-white shadow-sm">
                    <div className="d-flex align-items-center">
                        <a className="font-weight-bold text-dark text-back text-decoration-none " href="home.html">
                        ...
                        <span className="ml-3 h6 mb-0">Most Popular <small>20 places</small></span>
