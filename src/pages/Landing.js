  ...
  return (
    <>
      <div className="vh-100 landing-page-skip">
        <Link className="position-absolute btn-sm btn btn-outline-primary m-4 zindex" to="/location">Skip <i className="feather-chevrons-right" /></Link>
        <div className="osahan-slider">
          <div className="osahan-slider-item text-center">
            <div className="d-flex align-items-center justify-content-center vh-100 flex-column">
              <img src="img/landing1.svg" className="img-fluid mx-auto" alt="Responsive image" />
          ...
          <div className="osahan-slider-item text-center">
            <div className="d-flex align-items-center justify-content-center vh-100 flex-column">
              <img src="img/landing2.svg" className="img-fluid mx-auto" alt="Responsive image" />
          ...
          <div className="osahan-slider-item text-center">
            <div className="d-flex align-items-center justify-content-center vh-100 flex-column">
              <img src="img/landing3.svg" className="img-fluid mx-auto" alt="Responsive image" />
              <h4 className="my-4 text-dark">Pick Up Or Delivery</h4>
              <p>We make food ordering fast, simple and free - no matter if you order online or cash.</p>
            </div>
          </div>
        </div>
      </div>
