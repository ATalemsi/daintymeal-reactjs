            ...
            <div className="py-3 osahan-profile">
                <div className="bg-white shadow">
                    <div className="d-flex align-items-center border-bottom p-3">
                        ...
                        <div className="right">
                            <h6 className="mb-1 font-weight-bold font-bold">Nellie H. Riggs <i className="feather-check-circle text-success" /></h6>
                            <p className="text-muted m-0 small">yourmail@gmail.com</p>
                        </div>
                    </div>
