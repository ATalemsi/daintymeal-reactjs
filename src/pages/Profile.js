                    ...
                    <div className="bg-white shadow">
                        <div className="flex items-center border-b p-3">
                            <div className="relative flex-shrink-0"> {/* Add relative class */}
                                <img src={user?.avatar || 'img/user1.jpg'} className="rounded-full w-12 h-12" alt="User" />
                                <label
                            ...
                            <div className="text-left ml-3">
                                <h6 className="mb-1 font-bold text-md">{user?.name || 'Nellie H. Riggs'} <i className="feather-check-circle text-green-500" /></h6>
                                <p className="text-sm m-0">{user?.email || 'yourmail@gmail.com'}</p>
                            </div>
                        </div>
